...
const features = [
  {
    number: "01",
    title: "Unified Enterprise Data",
    description: "Connect banks, ERPs, payment gateways, ledgers, APIs, documents, and live events into one intelligent operational layer—without replacing your existing systems.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Intelligent Orchestration",
    description: "Distributed AI agents understand business context, coordinate workflows, and transform enterprise data into intelligent, explainable actions.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Traceability & Financial Proof",
    description: "Every event, decision, and transaction is connected through complete evidence, audit trails, and proof—bringing clarity to complex enterprise operations.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Enterprise Governance",
    description: "Security, compliance, observability, and governance are built into every layer of the platform, making Arealis ready for regulated enterprise environments.",
    visual: "security",
  },
];
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            Infrastructure for Enterprise Intelligence.
            <br />
            <span className="text-muted-foreground">Built to connect data, orchestrate AI, and execute with complete traceability.</span>
          </h2>
        </div>
