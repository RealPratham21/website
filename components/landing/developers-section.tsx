...
const codeExamples = [
  {
    label: "Install",
    code: `npm install @arealis/sdk

# or
yarn add @arealis/sdk
pnpm add @arealis/sdk`,
  },
  {
    label: "Initialize",
    code: `import { Arealis } from '@arealis/sdk'

const arealis = new Arealis({
  apiKey: process.env.AREALIS_KEY
})`,
  },
  {
    label: "Deploy",
    code: `const orchestration = await arealis.deploy({
  name: 'enterprise-ops',
  region: 'secure',
  governance: {
    audit: true,
...
console.log('Live at:', orchestration.url)`,
  },
];
